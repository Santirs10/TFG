    ...
    <script>
        ...
        function ComprobarContraseña() {
            ...
            if (pass.length >= 8 && tieneMayuscula && tieneMinuscula && tieneNumeros && tieneCaracterEspecial) {
                ...
                alert("La contraseña tiene que ser de mínimo 8 caracteres y tener mayúsculas, minúsculas y caracteres especiales")
            }
        }
    ...
    <div class="container">
        ...
        <form class="formulario" action="register.php" method="POST">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="text" class="form-control" id="inputemail" name="email" placeholder="ejemplo@email.com" required>
                </div>
            </div>
            <div class="form-group row">
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-8">
                    <input type="password" class="form-control" id="inputPassword" name="CLAVE_CLARO" placeholder="Clave de acceso"
                        required>
                </div>
                <div class="col-sm-2">
